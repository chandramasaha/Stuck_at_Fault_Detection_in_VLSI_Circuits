...
# Ensure consistent pattern lengths
...
encoding_layer = Dense(256, activation='relu')(input_layer)
...
history = autoencoder.fit(X_train, X_train, epochs=25, batch_size=32, validation_data=(X_test, X_test), callbacks=[early_stopping])
...
threshold = np.percentile(reconstruction_errors_full, 95)
